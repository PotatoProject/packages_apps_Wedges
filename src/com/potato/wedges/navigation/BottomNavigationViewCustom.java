...
package com.potato.wedges.navigation;
 ...
 * &lt;android.support.design.widget.BottomNavigationViewCustom
...
public class BottomNavigationViewCustom extends FrameLayout {
    ...
    /**
     * @return The maximum number of items that can be shown in BottomNavigationViewCustom.
     */
